...
int main()
{
	...
	iResult = checkIfPositive<int, OBJ_INT>(objInt, 1, 2, 3, std::ref(total)); //<-- Total is output param
	...
	sResult = checkIfPositive<int, OBJ_STR>(objStr, 1, 2, 3, std::ref(total)); //<-- Total is output param
