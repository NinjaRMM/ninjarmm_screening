...
// I am not sure if this is allowed as a soluton, but I created a second instance of checkIfPositive with the total.
// I attempted to add the total to the original function but failed to properly debug it in time.
template <typename T, typename U>
