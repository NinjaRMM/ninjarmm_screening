...
template<typename T>
concept IntegralOrString = std::integral<T> || std::is_same_v<std::string, T>;

// Looking at the code, the return type of the 'getResult' functions, is contrived to;
// 'bool', 'int' or 'string'

// Just to show off the use of Concepts I'm constraining the template function 'checkIfPositive'
// return type to match the types returned by the 'getResult' functions
// This is not necessary, but it's a good example of how to use Concepts

template <IntegralOrString T, typename U>
