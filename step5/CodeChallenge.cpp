...
/** 
 * Overload to deal with callers that originally passed 2 args, this just moves the default value 
 * down into this overload and chains to the the 3 int version
 */
template <typename T, typename U>
T checkIfPositive(const U& u, const int& param1, const int& param2)
{
   return checkIfPositive<T, U>(u, param1, param2, 0);
}

/**
 * Now that we can add our 4th param since the default is gone, lets add it and put in the sum and return it
 */
template <typename T, typename U>
