...
// There must be a way to reference a null value to the total variable added on the call, however, this must be discussed
// with the team whats the best approach, for this test i've choosed a static variable with -1 attached so we can 
// use this as an reference to check if the parameter is being used.
//
// You can allways create another function and make a lot of polymorph functions in order to make it work,
// however, this solution is easyer and cleaner.
//
static int null_reference = -1;
template <typename T, typename U>
T checkIfPositive(const U& u, const int& param1, const int& param2, int param3 = 0, int & total = null_reference )
{
