...
T checkIfPositive(const U& u, const int& param1, const int& param2, int param3 = 0, int * sum = nullptr )
{
...
int main()
{
    ...
    sResult = checkIfPositive<std::string, OBJ_STR>(objStr, 1, 2, 100, &total); //<-- Total is output param
