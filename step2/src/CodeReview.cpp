...
/* Missing CLSCTX_INPROC_SERVER definition. Maybe 'wtypesbase.h' should be included*//*
...
/* Missing WSC_SECURITY_PROVIDER_ANTIVIRUS definition. Maybe wscapi.h should be included */
/* Missing LPVOID definition. Maybe 'windows.h' should be included*/
/* Missing CoCreateInstance definition. Maybe 'combaseapi.h' should be included*/
/* Missing uint32_t definition. Maybe 'cstdint' should be included*/
...
bool queryWindowsForAVSoftwareDataWSC(std::map<std::wstring, ThirdPartyAVSoftware>& thirdPartyAVSoftwareMap)
{
    ...
    for (uint32_t i = 0; i < ProductCount; i++)
    {
        ...
        if (FAILED(hr))
        {
            /* Should PtrProduct->Release() and SysFreeString(PtrVal) functions be called?*/
