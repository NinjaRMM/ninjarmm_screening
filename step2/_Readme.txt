...
The major changes proposed in this piece of code were:
 ...
 - the Builder pattern was used to give flexibility to the WSC_SECURITY_PROVIDER, separating 
   the logic of the construction of the list element from the implementation of the queries themselves.
   In this case just the WSC_SECURITY_PROVIDER_ANTIVIRUS provided is implemented, but other 
   provides may be implemented too. 
