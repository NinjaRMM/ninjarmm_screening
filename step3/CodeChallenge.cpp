...
// MARLON ZANARDI: I modified the checkIfPositive template function to accept an additional integer parameter, which will be used as an output parameter to store the total of the integer parameters passed to the function.
...
int main()
{
    ...
    // MARLON ZANARDI: With this modification, you should be able to call the checkIfPositive function with an additional integer parameter to store the total
    int total = 0;
