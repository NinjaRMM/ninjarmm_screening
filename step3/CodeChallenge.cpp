...
// Because there is no way to differentiate between param 3 and total, the total will only be used when up to param 3 exists
// Therefore we create a new template with param1, param2 and param3 as constant integers and total as a parameter integer without initialization
//(Because it would conflict with the working of the other template, giving several errors).
template <typename T, typename U>
