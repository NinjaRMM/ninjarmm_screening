...
T checkIfPositive(const U& u, const int& param1, const int& param2, const int& param3, int& total)
{
    ...
    */
    ...
    // I didn't realize the purpose of this variable, my best guess the 'total' var is the sum of parameters.
    // getResult already do this sum, but I cannot change getResult code, so I have to make this sum again?
...
{
    int total;
    return checkIfPositive<T, U>(u, param1, param2, param3, total);
}
