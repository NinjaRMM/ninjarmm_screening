...
// We can overload the template function "checkIfPositive", adding another parameter for the total, "param4".
// We also need to make param3 mandatory, to avoid ambiguity at the moment the compiler
// tries to resolve the overloading.
template <typename T, typename U>
T checkIfPositive(const U& u, const int& param1, const int& param2, int param3, int& param4)
{
    ...
    */
    param4 = param1 + param2 + param3; // Get the total.
