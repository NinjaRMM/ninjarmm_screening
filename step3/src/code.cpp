...
//T checkIfPositive(const U& u, const int& param1, const int& param2, int param3 = 0) // ORIGINAL CODE
	T checkIfPositive(const U& u, const int& param1, const int& param2, int param3 = 0, int& total = 0) //NEW CODE HERE
	{
...
int main()
{
	...
	//How are you going to solve this problem? -> Changed code in the template above (line 39).
