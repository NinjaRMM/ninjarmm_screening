...
T checkIfPositive(const U& u, const int& param1, const int& param2, int param3 = 0, int* ptrTotal = 0)
{
    ...
    */
    // The only way that I could figure out how to make this work was to create a pointer for total, but that affects the calls (see below in main())
    if (ptrTotal > 0) {
        *ptrTotal = param1 + param2 + param3;
    }
...
int main()
{
    ...
    std::cout << iResult << std::endl;
                                                        // had to edit the call to reference the pointer, not sure if this is the best way to go about this step
